...
public class OutboundController {
    ...
    public void list(Model model, PageRequestDTO pageRequestDTO){
        PageResponseDTO pageResponseDTO = outboundService.list(pageRequestDTO);
    ...
    @GetMapping({"/outbound/read", "/outbound/modify"})
    public void read(Long outboundId, PageRequestDTO pageRequestDTO, Model model){
        OutboundDTO outboundDTO = outboundService.readOne(outboundId);
        log.info(outboundDTO);
    ...
    public String modify(@Valid OutboundDTO outboundDTO,
        ...
        if(bindingResult.hasErrors()){
            ...
            return "redirect:/mes/outbound/modify?"+link;
        }

        outboundService.modify(outboundDTO);
        redirectAttributes.addFlashAttribute("result", "modified");
        redirectAttributes.addAttribute("outboundId", outboundDTO.getOutboundId());
        return "redirect:/mes/outbound/read";
    }
