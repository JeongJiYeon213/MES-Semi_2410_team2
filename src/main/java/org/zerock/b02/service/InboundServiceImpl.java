...
public class InboundServiceImpl implements InboundService{
    ...
    public Long register(InboundDTO inboundDTO){
        ...
        Product product = productRepository.findByProductCode(inboundDTO.getProductCode())
                .orElseThrow(() -> new RuntimeException("Product not found with productCode: " + inboundDTO.getProductCode()));

        Supplier supplier = supplierRepository.findBySupplierId(inboundDTO.getSupplierId())
                .orElseThrow(() -> new RuntimeException("Supplier not found with supplierId: " + inboundDTO.getSupplierId()));
