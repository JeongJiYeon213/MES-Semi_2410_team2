...
public class OutboundSearchImpl implements OutboundSearch {
    ...
    @Override
    public Page<Outbound> searchAll(String[] types, String keyword, Pageable pageable) {
        // JPQL로 작성
            ...
            for (int o = 0; o < types.length; o++) {
                ...
                switch (type) {
                    case "a":
                        ...
                        break;
                    case "b":
                        jpql.append("o.productCode LIKE :keyword");
                        break;
                    case "c":
                        jpql.append("o.supplierId LIKE :keyword");
                        break;
                    case "d":
