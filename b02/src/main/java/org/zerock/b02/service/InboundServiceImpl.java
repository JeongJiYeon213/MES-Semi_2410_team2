...
public class InboundServiceImpl implements InboundService{
    ...
    @Override
    public InboundDTO readOne(Long inbound_id){
        Optional<Inbound> result = inboundRepository.findById(inbound_id);
    ...
    public PageResponseDTO list(PageRequestDTO pageRequestDTO){
        ...
        Pageable pageable = pageRequestDTO.getPageable("inbound_id");
